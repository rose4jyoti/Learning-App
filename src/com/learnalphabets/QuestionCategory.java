   ...
   for(int i = 0;i < arrayResult.size();i++) {
        ...
        SQLiteQueryBuilder qbOne1 = new SQLiteQueryBuilder();
	     ...
	     if(resultcur.moveToFirst()) {	    	 
	    	 ...
	    	 arraySound.add(resultcur.getString(2));         
...
private void populatesoundArray(){
	CorrtSoundArray.add(Integer.toString(raw.awesome));
   CorrtSoundArray.add(Integer.toString(raw.correct));
   CorrtSoundArray.add(Integer.toString(raw.correctanswer));
   CorrtSoundArray.add(Integer.toString(raw.great));
   CorrtSoundArray.add(Integer.toString(raw.perfect));
   CorrtSoundArray.add(Integer.toString(raw.rightanswer));
   CorrtSoundArray.add(Integer.toString(raw.superbanswer));
   CorrtSoundArray.add(Integer.toString(raw.verynice));
   CorrtSoundArray.add(Integer.toString(raw.rightanswer));
   CorrtSoundArray.add(Integer.toString(raw.superbanswer));
   CorrtSoundArray.add(Integer.toString(raw.verynice));
   InCorrtSoundArray.add(Integer.toString(raw.pleasetryagain));
   InCorrtSoundArray.add(Integer.toString(raw.thisanswerisincorrect));
   InCorrtSoundArray.add(Integer.toString(raw.thisiswronganswer));
